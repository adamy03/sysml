...
def run_tests():
    ...
    # 5 second video at different resolutions and 15 fps
    take_video(640, 480, 15, 5, "./5sec_480.mp4")
    #take_video(1280, 720, 15, 5, "./5sec_720.mp4")
    #take_video(1920, 1080, 15, 5, "./5sec_1080.mp4")
