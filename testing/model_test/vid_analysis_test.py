...
def process_video(video_path, model):
    ...
    # Store the results of the last processed frame. If we skip a frame,
    # fill "comparison" with the last processed frame
    ...
    while cap.isOpened():
        ...
        # Run prediction on this frame. We have to run it regardless of our
        # filtering method so we can assess ground truth
