...
if __name__ == '__main__':
    ...
    out = exec_file(SSH_PI4 + ' ' + "'python ~/sysml/testing/model_test/yolov5-on-rpi4-2020/johnston_yolov5/yolov5/detect.py --weights yolov5n.pt --save-txt --conf 0.2 --name german_yolov5n --source /home/pi/german.mp4")
    

    # Change file name/path as needed, assumes run_test is run from sysml directory
    out.to_csv("~/sysml/testing/test_results/german/german_yolov5n.csv")
    #out.to_csv("~/sysml/testing/test_results/yolov5n/5sec_720_noresize.csv")
    #out.to_csv("~/sysml/testing/test_results/yolov5n/5sec_1080_noresize.csv")
