...
if __name__ == '__main__':
    ...
    out = exec_file(SSH_PI3 + ' ' + "'python ~/sysml/testing/model_test/yolov5-on-rpi4-2020/johnston_yolov5/yolov5/detect.py --weights yolov5n.pt --conf 0.2 --source /home/pi/sysml/testing/sensing/video_test/5sec_1080.mp4")
